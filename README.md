...
eersteTest\projectI\app\Providers/RouteServiceProvider.php

// start   fix voor Laravel 8 Controller
protected $namespace = 'App\Http\Controllers';

& in api + web
->namespace($this->namespace)

#service provider: voorkom uitgevoerd artisan vóórdat de dependency is included
